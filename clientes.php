...
<head>
  ...
  <link rel="stylesheet" href="css/CLIENTES.css" medi a="screen">
          ...
          <div class="u-expanded-width u-form u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 0px;">
              ...
              <div class="u-form-group u-form-group-3">
                ...
                <input type="text" placeholder="Digite o nome do Cliente" id="text-302c" name="nomeCliente" class="u-border-2 u-border-palette-4-light-3 u-input u-input-rectangle u-palette-4-light-3 u-radius-10" required="required">
              </div>
