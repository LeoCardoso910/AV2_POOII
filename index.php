      ...
      <div class="u-list u-list-1">
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            <li class="u-nav-item"><a class="u-nav-link u-text-active-black" href="index.php" style="padding: 10px 20px;">LOJA PHP</a>
	    </li>
            ...
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="pages/clientes.php" style="padding: 10px 20px;">CLIENTES</a>
            </li>
          </ul>
        </div>
	</div>
